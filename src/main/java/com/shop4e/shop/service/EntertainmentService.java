...
public interface EntertainmentService {
  ...
  EntertainmentResponse createEntertainment(EntertainmentCreationRequest request, Optional<List<MultipartFile>> images,
      Authentication principal);

  EntertainmentResponse getEntertainment(String id);

  EntertainmentResponse updateEntertainment(String id, EntertainmentUpdateRequest request, Optional<List<MultipartFile>> images,
      Authentication principal);
}
